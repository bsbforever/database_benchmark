...
public class BenchService {
    ...
    public void startBenchmark(Long intervalMs, Integer sampleRate, Integer writeRatio,
        ...
        this.currentWriteRatio = (writeRatio != null) ? writeRatio : 2; // 默认2个写
        ...
        new Thread(() -> {
            ...
            try {
                ...
                sendLog("LOG", String.format("🚀 目标: %s:%s | 频率: %dms | 读写比: %d:%d",



                        targetIp, targetPort, actualInterval, (10 - this.currentWriteRatio), this.currentWriteRatio));
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            try {
                ...
                for (int i = 0; i < numWrites; i++) {
                    ...
                    // Alternate between REPLACE/MERGE and UPDATE for more varied write workload
